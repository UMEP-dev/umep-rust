"""
SOLWEIG config wrapper for Python.

TODO: Separate config reading and SOLWEIG run.
"""
...
from umep.functions.SOLWEIGpython.CirclePlotBar import PolarBarPlot
from umep.functions.SOLWEIGpython.patch_characteristics import hemispheric_image
from umep.functions.SOLWEIGpython.Tgmaps_v1 import Tgmaps_v1
from umep.functions.SOLWEIGpython.wall_surface_temperature import load_walls
...
from umep.util.SEBESOLWEIGCommonFiles.Solweig_v2015_metdata_noload import Solweig_2015a_metdata_noload
from umep.util.umep_solweig_export_component import read_solweig_config

from .hybrid import solweig_hybrid as so
...
try:
    ...
    from umep.functions.SOLWEIGpython.wallOfInterest import pointOfInterest
    from umep.util.misc import saveraster, xy2latlon_fromraster
except:
    pass
