...
across all 35 spatial comparisons is 2.20e-02 (PET grid), which is well within
the 0.2 C tolerance for the iterative PET solver. Most components agree to
better than 1e-04, confirming that the Rust reimplementation is numerically
faithful to the UMEP Python reference.
